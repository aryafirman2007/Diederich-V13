...
let memek = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 9999999999, status: 1, thumbnail: await conn.resize(await getBuffer(thumb),300,150), surface: 1, message: 'ᴅɪᴇᴅᴇʀɪᴄʜ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
...
`.trimStart(),
  ...
  footer: '╚═─━╍╍━╍╾',
  after: `ᴅɪᴇᴅᴇʀɪᴄʜ ᴀɪ ${global.version}`,
}
  try {
    ...
    let bjir = 'https://files.catbox.moe/gmkx7d.jpg'
 ...
 conn.sendMessage(m.chat, {
      video: fs.readFileSync('./menuvid/Diederich.mp4'),
            mimetype: 'video/mp4',
            fileLength: 1000000,
            caption: Styles(text),
            gifPlayback: true,
 ...
 type: 'audioMessage',  
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴅɪᴇᴅᴇʀɪᴄʜ ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', body: wm, sourceUrl: 'https://chat.whatsapp.com/LnEShOfN7fF6xL62EAUuG9', thumbnail: await (await fetch(bjir)).buffer(),}}  
  }) 
    } catch (e) {
